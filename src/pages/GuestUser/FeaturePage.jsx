...
export default function FeaturePage() {
  ...
  return (
    <div className="flex flex-col pt-20 items-center w-full bg-gray-50 dark:bg-gray-900 text-primary dark:!text-gray-100 transition-colors duration-300">
      {/* Hero Section */}
      <section className="w-full max-w-7xl flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-12 py-20">
        ...
        <div className="mb-10 md:mb-0 flex justify-center">
          <img
            ...
            className="w-72 md:w-96 lg:w-[28rem] drop-shadow-lg"
          />
        </div>
      </section>

      {/* Dashboard Section */}
      <section className="w-full max-w-7xl flex flex-col md:flex-row items-center justify-between px-6 md:px-12 py-20 gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left space-y-4">
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            deadlines, and updates come together in one simple view — complete with
            quick stats to track progress at a glance.
          </p>
        </div>
      </section>
      ...
      <section className="w-full max-w-7xl flex flex-col md:flex-row items-center justify-between px-6 md:px-12 py-20 gap-12">
        <div className="md:w-1/2 text-center md:text-left order-2 md:order-1 space-y-4">
          <h2 className="text-3xl font-bold">Project Management</h2>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            Stay focused with dashboards, task lists, and timelines that keep your
            projects moving forward — without the chaos.
          </p>
        </div>
      ...
      <section className="w-full max-w-7xl flex flex-col md:flex-row items-center justify-between px-6 md:px-12 py-20 gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left space-y-4">
          <h2 className="text-3xl font-bold">Team Collaborators</h2>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            Add members to your workspace easily. Invite collaborators via email
            or shareable link, and assign specific roles to control access and
      ...
      <section className="w-full max-w-7xl flex flex-col md:flex-row items-center justify-between px-6 md:px-12 py-20 gap-12">
        <div className="md:w-1/2 text-center md:text-left order-2 md:order-1 space-y-4">
          <h2 className="text-3xl font-bold">Invite by Email</h2>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
