...
const TaskFlowChatbot = () => {
  const [messages, setMessages] = useState([
    { type: "bot", text: "Hello, I'm TaskFlowBot. I can help you with TaskFlow questions or chat about anything!" },
  ]);
  ...
  return (
    <div className="bg-gray-100 flex items-center justify-center min-h-screen p-4">
      <div className="w-full max-w-md h-[600px] bg-white rounded-xl shadow-2xl flex flex-col overflow-hidden">
        {/* Header */}
          ...
          <div className="flex items-center space-x-3">
            <div className="relative">
              <img 
                src={Chatbot} 
                alt="TaskFlow Bot" 
                className="w-11.8 h-8 object-cover"
              />
            ...
            <div>
              ...
              <div className="text-xs text-blue-100">Always ready to help</div>
            </div>
          </div>
